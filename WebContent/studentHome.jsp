...
<center><img src="cit.png" width="150" height="150">
</center>
...
@import url(https://fonts.googleapis.com/css?family=Roboto:500,600,300,700);
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Coimbatore Institute of Technology</th>
...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>NAS102</td>
        <td colspan="2">Mobile computing</td>
        <td>Theory</td>
        <td>100</td>
        <td>30</td>
      ...
      <tr>
        <td>NAS151</td>
        <td colspan="2">Mobile application Lab</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
